    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[var(--bg-primary)] to-[var(--bg-secondary)] p-4">
      ...
      >
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-xl font-bold text-theme-primary">Регистрация</h1>
          <p className="text-sm text-theme-muted mt-1">Создайте аккаунт Luna</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <div>
            <label className="text-xs font-medium text-theme-secondary block mb-1">Имя (необязательно)</label>
            <input
              type="text"
              value={nickname}
          ...
          {error && (
            <motion.p
              ...
              animate={{ opacity: 1, y: 0 }}
              className="text-xs text-red-500 bg-red-50/10 px-3 py-2 rounded-theme-sm"
            >
              {error}
            </motion.p>
          )}
